...
public class SetphoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button setphone_button = findViewById(R.id.setphone_button);
        ...
        setphone_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String str_newphone = newphone.getText().toString();
                ...
                String request_url = Constants.BACKEND_LOCATION + "/setPhone?userid=" + userid
                        + "&newphone=" + str_newphone;
                    ...
                    public void run() {
                        try {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(getApplicationContext(), "Set Phone Successful", Toast.LENGTH_LONG).show();
                                    Intent intent = new Intent(SetphoneActivity.this, SettingActivity.class);
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(getApplicationContext(), "Set Phone Error", Toast.LENGTH_LONG).show();
                                }
                            });
